---
title: "Collecting stepAIC Results Carcass Without Covariables"
...
# Anwendung
Modellselektion für Schlachtmerkmale unterteilt nach Produktionssystem, wobei keine Covariable für das Schlachtalter da es selber als Merkmal enthaltet ist.
...
vec_ignoring_columns <- c("herdyear","herd","prodsystem","calfcull","controlcull","ageVK","slaughterCategory","branding","age","ageQuadrat",
...
## Parameter für Schlachtgewicht und Schlachtalter

Im Gegensatz zu Fleischigkeit und Fettabdeckung enthält das Schlachtgewicht und Hilfsmerkmal Schlachtalter keine Klassifierer als fixen Effekt.
...
# specify a vector with columns to be ignored
vec_ignoring_columns_cw <- c("herdyear","herd","prodsystem","calfcull","controlcull","ageVK","slaughterCategory","branding",
                             "classifier","age","ageQuadrat",
                              "cccn","ccco","ccan","ccas","ccao","ccvn","ccvo",
                              "cwcn","cwco","cwan","cwas","cwao","cwvn","cwvo",
                              "cfcn","cfco","cfan","cfas","cfao","cfvn","cfvo",
                              "cacn","caco","caan","caas","caao","cavn","cavo",
                              "ind")
# specify a vector of fixed effects
vec_fixeffect_columns_cw <- c("sex","abattoir","yearsaison","breedcomb","Effekt_HeterosisSumHet","Effekt_RekombinationSumRec")
```
