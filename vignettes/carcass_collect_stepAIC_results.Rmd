...
* dir = Pfad wo sich die Daten für Modellselektion befinden
...
```{bash, eval=FALSE}
R -e "rmarkdown::render(file.path(system.file(package = 'ModelSelection'), 'template.Rmd'), params = dget(file = 'pardir/template.par'), output_dir = 'outdir')"
```
